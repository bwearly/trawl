  ...
  return {
    ...
    recentDisclosures: recentDisclosures.map((row) => {
      ...
      return {
        ...
        tradeTypeScore: toNumber(row.tradeTypeScore),
        tradeSizeScore: toNumber(row.tradeSizeScore),
        filingFreshnessScore: toNumber(row.filingFreshnessScore),
        historicalPoliticianScore: toNumber(row.historicalPoliticianScore),
        momentumScore: toNumber(row.momentumScore),
        committeeRelevanceScore: toNumber(row.committeeRelevanceScore),
        clusterScore: toNumber(row.clusterScore),
        userRelevanceScore: toNumber(row.userRelevanceScore),
        return7d,
        return30d,
        return90d,
        spyReturn7d,
